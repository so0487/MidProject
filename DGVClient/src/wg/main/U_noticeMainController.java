...
public class U_noticeMainController {
	...
	public void dataDisplay(List<NoticeVO> list) {
		...
		for(NoticeVO noticeVo : list) {
			try {
				FXMLLoader loader1 = new FXMLLoader(U_noticeMainController.class.getResource("../fxml/U_Notice.fxml"));
				Parent center = loader1.load();
				U_noticeOneController setOneController = loader1.getController();
				...
				center.setOnMouseClicked(e->{
					try {
						...
						FXMLLoader loader = new FXMLLoader(U_noticeMainController.class.getResource("../fxml/U_NoticeDetail.fxml"));
						Parent seletedNotice = loader.load();
						outerbox.setCenter(seletedNotice);
						U_noticeDetailConroller detailCon = loader.getController();
